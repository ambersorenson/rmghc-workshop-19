...
annotation = Channel.fromPath("$HOME/workshop/annotation/*")
genome = Channel.fromPath("$HOME/workshop/genome/*")
sample_info_for_de = Channel.fromPath("$HOME/workshop/sample_info/*")
index = Channel.fromPath("$HOME/workshop/index")
